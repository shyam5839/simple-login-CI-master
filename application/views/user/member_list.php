        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('user/update_member'); ?>" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"> <label>Old Registration Number:</label>
                                <div class="right-align"><input type="text" name="old_reg_no" value=""></div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Member Name:</label>
                                <div class="right-align"><input type="text" name="member_name" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Address:</label>
                                <div class="right-align"><input type="text" name="Address" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Street:</label>
                                <div class="right-align"><input type="text" name="street" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Place:</label>
                                <div class="right-align"><input type="text" name="place" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Pincode:</label>
                                <div class="right-align"><input type="text" name="pincode" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Residence Phone:</label>
                                <div class="right-align"><input type="text" name="residence_phone" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Official Phone:</label>
                                <div class="right-align"><input type="text" name="official_phone" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Mobile Number:</label>
                                <div class="right-align"><input type="text" name="Mobile_no" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Email:</label>
                                <div class="right-align"><input type="text" name="email" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Jamaath Ward:</label>
                                <div class="right-align"><input type="text" name="jamaath_ward" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>LSG Ward:</label>
                                <div class="right-align"><input type="text" name="lsg_ward" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Panchayath:</label>
                                <div class="right-align"><input type="text" name="panchayath" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Taluk:</label>
                                <div class="right-align"><input type="text" name="taluk" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Village:</label>
                                <div class="right-align"><input type="text" name="village" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>District:</label>
                                <div class="right-align"><input type="text" name="district" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Birth Date:</label>
                                <div class="right-align"><input type="text" name="birth_date" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Birth Place:</label>
                                <div class="right-align"><input type="text" name="birth_place" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Father Member ID:</label>
                                <div class="right-align"><input type="text" name="father_member_id" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Gender:</label>
                                <div class="right-align"><input type="text" name="gender" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Death Date:</label>
                                <div class="right-align"><input type="text" name="death_date" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Buried Date:</label>
                                <div class="right-align"><input type="text" name="buried_date" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Buried Place:</label>
                                <div class="right-align"><input type="text" name="buried_place" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Death Reason:</label>
                                <div class="right-align"><input type="text" name="death_reason" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Place of Death:</label>
                                <div class="right-align"> <input type="text" name="place_of_death" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Existing Subscription Money:</label>
                                <div class="right-align"> <input type="text" name="existing_subscription_money" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Revised Subscription Money:</label>
                                <div class="right-align"> <input type="text" name="revised_subscription_money" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Imam's Allowance:</label>
                                <div class="right-align"> <input type="text" name="imams_allowance" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Mosque Allowance:</label>
                                <div class="right-align"><input type="text" name="mosque_allowance" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Deceased or Handicapped:</label>
                                <div class="right-align"> <input type="text" name="deceased_or_handicapped" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Nominee:</label>
                                <div class="right-align"> <input type="text" name="nominee" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Relation with Nominee:</label>
                                <div class="right-align"> <input type="text" name="relation_with_nominee" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Ex Jamaath:</label>
                                <div class="right-align"> <input type="text" name="ex_jamaath" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Census Taken By:</label>
                                <div class="right-align"> <input type="text" name="census_taken_by" value="
        "> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Census Taken At:</label>
                                <div class="right-align"> <input type="text" name="census_taken_at" value="
        "> </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group"> <label>ID Proof:</label>
                                <div class="right-align"> <input type="text" name="id_proof" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Membership Type:</label>
                                <div class="right-align"> <input type="text" name="membership_type" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Qualification:</label>
                                <div class="right-align"><input type="text" name="qualification" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Blood Group:</label>
                                <div class="right-align"> <input type="text" name="blood_group" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Main Member Relation:</label>
                                <div class="right-align"> <input type="text" name="main_member_relation" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Occupation:</label>
                                <div class="right-align"> <input type="text" name="occupation" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Status:</label>
                                <div class="right-align"> <input type="text" name="status" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Created By:</label>
                                <div class="right-align"> <input type="text" name="created_by" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Updated By:</label>
                                <div class="right-align"> <input type="text" name="updated_by" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Monthly Income:</label>
                                <div class="right-align"> <input type="text" name="monthly_income" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Eid Income:</label>
                                <div class="right-align"><input type="text" name="eid_income" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Bakrid Income:</label>
                                <div class="right-align"><input type="text" name="bakrid_income" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Created At:</label>
                                <div class="right-align"> <input type="text" name="created_at" value=""> </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group"> <label>Updated At:</label>
                                <div class="right-align"> <input type="text" name="updated_at" value=""> </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
