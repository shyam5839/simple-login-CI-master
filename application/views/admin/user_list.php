        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <select name="role" id="role" class="form-control">
                                ...
                                <option value="admin">Masjid</option>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Image</label>
                        <input class="form-control" id="image" placeholder="Image URL" name="image" type="file"
                            autofocus>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="edit-name" placeholder="Name" name="edit-name" type="text"
                                autofocus>
                        </div>
                    </div>
                    <div class="col-lg-6">
